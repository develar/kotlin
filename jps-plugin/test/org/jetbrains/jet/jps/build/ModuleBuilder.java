...
import org.jetbrains.jps.incremental.artifacts.LayoutElementTestUtil;
...
public class ModuleBuilder {
  private static final Map<ArtifactBuilderTestCase, Pair<AtomicInteger, AtomicInteger>> testCaseToNameCounter = new THashMap<ArtifactBuilderTestCase, Pair<AtomicInteger, AtomicInteger>>();
  ...
  private final String fromSourceRoot;
  ...
  public static JpsArtifact createArtifact(ModuleBuilder... builders) {
    ...
    return builders[0].testCase.addArtifact(root);
  }
  ...
  public JpsArtifact createArtifact() {
    JpsArtifact artifact = testCase.addArtifact(root().element(createPackagingElement(get())));
